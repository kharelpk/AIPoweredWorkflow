      ...
      <div className="homeContainer">
        ...
        <InputBar className="mt-25" onSend={(text) => {
            ...
            <div className="examples mt-4 text-white">
                    ...
                    <li className="ml-10 mt-4 text-white font-mono Monaco text-sm">"I have two Thorlabs stages with brushless DC motor controllers. I am using a Thorlabs power meter to measure the optical power of a pure photonics laser. I want to run gradient search optimization on the two stages to maximize optical power."</li>                    {/* <li className="ml-10 mt-4 text-white"> "I want to synchronously acquire power readings from a Thorlabs Power meter and images from a ueye camera. The power readings are stored in a database whereas the camera images are stored in numpy array."</li> */}
                    <li className="ml-10 mt-4 text-white font-mono Monaco text-sm">"Simultaneously acquire data from a spectrometer and a machine vision camera at 65 Hz speed for 10 seconds. In parallel, record timing data to an excel file."</li>               
